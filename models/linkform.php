 ...
 * @since  1.6
 */
class Auto79ModelLinkForm extends JModelForm
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_auto79.edit.link.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_auto79.edit.link.id', $id);
		}
	 ...
	 */
	public function getTable($type = 'Link', $prefix = 'Auto79Table', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_auto79.link', 'linkform', array(
				'control'   => 'jform',
				'load_data' => $loadData
			)
		);
	...
	{
		$data = JFactory::getApplication()->getUserState('com_auto79.edit.link.data', array());
