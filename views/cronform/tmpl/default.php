...
<div class="cron-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-cron"
			  action="<?php echo JRoute::_('index.php?option=com_auto79&task=cron.save'); ?>"
	...
	<?php foreach((array)$this->item->adcategories as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="adcategories" name="jform[adcategorieshidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />';
		<?php endif; ?>
	<?php endforeach; ?>
	...
	<?php echo $this->form->renderField('pagefrom'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_auto79&task=cronform.cancel'); ?>"
